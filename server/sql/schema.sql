...
create table match_tbl(match_id INT NOT NULL AUTO_INCREMENT, team1 int not null, team2 int not null, match_date datetime, winner int not null, primary key(match_id),
